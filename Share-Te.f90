...
!     layer of the related node
      SUBROUTINE SHARE_Te()
        ...
        neigh5: DO nbb = 1,26
           ...
           IF(.NOT.(((nb.eq.11.or.nb.eq.16).AND.(nynodes.ne.1.or.LIDY.eq.1)) &
                .or.((nb.eq.13.or.nb.eq.14).AND.(nxnodes.ne.1.or.LIDX.eq.1)) &
                .or.((nb.eq.5.or.nb.eq.22).AND.(nznodes.ne.1.or.LIDZ.eq.1)))) CYCLE neigh5
